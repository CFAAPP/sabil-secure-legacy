...
const translations = {
  fr: {
    ...
    username: "Pseudonyme (@)",
    usernameHint: 'Lettres, chiffres, . ou _ — 3 à 30 caractères. Sera unique et utilisé pour les mentions.',
    usernameTaken: 'Ce pseudonyme est déjà pris.',
    usernameInvalid: 'Pseudonyme invalide (3-30 caractères, lettres/chiffres/./_).',
    mentions: 'Mentions',
    mentionsUnknownSome: 'Ces pseudonymes n\'existent pas et ont été ignorés : ',
  ...
  en: {
    ...
    username: 'Username (@)',
    usernameHint: 'Letters, digits, . or _ — 3 to 30 chars. Will be unique and used for mentions.',
    usernameTaken: 'This username is already taken.',
    usernameInvalid: 'Invalid username (3-30 chars, letters/digits/./_).',
    mentions: 'Mentions',
    mentionsUnknownSome: "These usernames don't exist and were skipped: ",
  ...
  ar: {
    ...
    identity: 'هويتي',
    sharedWithMe: 'المشترك معي',
    contacts: 'جهات الاتصال',
    username: 'اسم مستعار (@)',
    usernameHint: 'أحرف وأرقام و . أو _ — من 3 إلى 30 حرفًا. سيكون فريدًا ويُستخدم للإشارات.',
    usernameTaken: 'هذا الاسم المستعار محجوز.',
    usernameInvalid: 'اسم مستعار غير صالح.',
    mentions: 'إشارات',
    mentionsUnknownSome: 'الأسماء المستعارة التالية غير موجودة وتم تجاهلها: ',
