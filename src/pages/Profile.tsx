...
const tr: Record<string, Record<string, string>> = {
  fr: {
    ...
    loading: 'Chargement...',
    noInfo: 'Renseigne ton profil familial pour que HISAB puisse calculer l\'héritage correctement.',
    summary: 'Résumé',
  ...
  en: {
    ...
    loading: 'Loading...',
    noInfo: 'Fill in your family profile so HISAB can correctly calculate the inheritance.',
    summary: 'Summary',
  ...
  ar: {
    ...
    noInfo: 'أدخل ملفك العائلي حتى يتمكن حساب من احتساب الإرث بشكل صحيح.',
    summary: 'ملخص',
